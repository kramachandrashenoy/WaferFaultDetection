...
class Data_Getter:
    ...
    def get_data(self):
        ...
        try:
            ...
            print(f"Reading data from {self.training_file}")  # Debug log
            self.data = pd.read_csv(self.training_file)
            print("Data loaded successfully")
            self.logger_object.log(self.file_object, 'Data Load Successful. Exited the get_data method')
            return self.data
        except Exception as e:
            self.logger_object.log(self.file_object, f'Exception occurred in get_data method: {str(e)}')
