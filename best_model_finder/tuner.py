...
class Model_Finder:
    ...
    Version: 1.0
    Revisions: Added debug logging and label encoding
    """
    ...
    def get_best_params_for_random_forest(self, train_x, train_y):
        ...
        try:
            ...
            self.logger_object.log(self.file_object, f'Error in get_best_params_for_random_forest: {str(e)}')
            raise
    ...
    def get_best_params_for_xgboost(self, train_x, train_y):
        ...
        try:
            ...
            if set(np.unique(train_y)) == {-1, 1}:
                ...
                self.logger_object.log(self.file_object, 'Labels encoded to [0, 1]')
            ...
            self.logger_object.log(self.file_object, f'Error in get_best_params_for_xgboost: {str(e)}')
            raise

    def get_best_model(self, train_x, train_y, test_x, test_y):
        """
        Method Name: get_best_model
        Description: Find the model with the best AUC score.
